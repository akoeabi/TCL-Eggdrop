set notc "2Control 4Eggdrop"
set notm "2Control 4Eggdrop"
set notb "2Control 4Eggdrop"
set ps "2Control 4Eggdrop"
set notd "2Control 4Eggdrop"
set ppp "#makmur"
set vern "2Control 4Eggdrop"
...
set querym {
"Maaf saya bukan manusia saya bot a.k.a mesin a.k.a enggdrop"
}
...
"Dancok!"
"Gatel!"
"Looking For SpAmER Afwan"
}

set partm {
"Kabooooooorrrrrrrrrrrrrrrrrr"
"Leaving"
"BaCk To Base Camp"
"Balik Ahhh...."
"License To Part!"
...
global botnick notd
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notd 4D14itolak1!"
return 0
}
...
puthlp "NOTICE $nick :$notd BoT Command LIsT."
puthlp "NOTICE $nick :RuNNINg WiTH EggDrop v[lindex $version 0] PoWERED BY [lgrnd] $vern"
puthlp "NOTICE $nick :MSG/PV COMMAND..!"
puthlp "NOTICE $nick :auth <password>          authenticate user"
puthlp "NOTICE $nick :deauth <password>        deauthenticate user"
puthlp "NOTICE $nick :pass <password>          set password"
puthlp "NOTICE $nick :passwd <oldpass> <newpass>  change user password"
puthlp "NOTICE $nick :userlist                 userlist"
puthlp "NOTICE $nick :op <#> <nick>            op someone"
puthlp "NOTICE $nick :deop <#> <nick>          deop someone"
puthlp "NOTICE $nick :voice <#> <nick>         voice someone"
puthlp "NOTICE $nick :devoice <#> <nick>       devoice someone"
puthlp "NOTICE $nick :kick <#> <nick|host> <reason>  kick someone"
puthlp "NOTICE $nick :kickban <#> <nick|host> <reason>  kickban someone"
puthlp "NOTICE $nick :identify <nick> <passwd> identify to nickserv someone access"
puthlp "NOTICE $nick :join <#>                 joining #channel temporary"
puthlp "NOTICE $nick :part <#>                 part #channels"
if {[matchattr $nick Z]} {
puthlp "NOTICE $nick :logo <your crew logo>    changing text logo on kick message"
puthlp "NOTICE $nick :vhost <IP DNS>           changing vhost"
puthlp "NOTICE $nick :away <msg>               set bot away message"
puthlp "NOTICE $nick :admin <msg>              set bot admin on status"
puthlp "NOTICE $nick :memo <user|all> <msg>    send memo to all user or one user"
puthlp "NOTICE $nick :bantime <minutes>        auto unban on X minutes (0 never unban)"
puthlp "NOTICE $nick :logchan <#|0FF>          log #channel"
puthlp "NOTICE $nick :4!!WARNING!! turn logchan on will decrease bot performance!"
puthlp "NOTICE $nick :<4DCC> .log              show #channel log"
puthlp "NOTICE $nick :6note > please increase on general - window buffer into 5000"
puthlp "NOTICE $nick :+chan <#>                joining permanent #channel"
puthlp "NOTICE $nick :botnick <nick> <id>      changing permanent bot primary nick"
puthlp "NOTICE $nick :botaltnick <nick> <id>   changing permanent bot alternate nick"
puthlp "NOTICE $nick :realname <bot realname>  changing permanent bot realname"
puthlp "NOTICE $nick :ident <bot ident>        changing permanent bot ident"
puthlp "NOTICE $nick :die                      kill bot"
}
puthlp "NOTICE $nick :MSG/CHANNEL COMMAND..!"
puthlp "NOTICE $nick :`up                      bot self op"
puthlp "NOTICE $nick :`down                    bot self deop"
puthlp "NOTICE $nick :`op/+o <nick>            op spesified nick"
puthlp "NOTICE $nick :`deop/-o <nick>          deop spesified nick"
puthlp "NOTICE $nick :`voice/+v <nick>         voice spesified nick"
puthlp "NOTICE $nick :`devoice/-v <nick>       devoice spesified nick"
puthlp "NOTICE $nick :`kick <nick> <reason>    kick spesified nick"
puthlp "NOTICE $nick :`kickban <nick> <reason> kickban spesified nick"
puthlp "NOTICE $nick :`mode <+/- settings>     mode setting #channel"
puthlp "NOTICE $nick :`ping / `pong            ping your self"
puthlp "NOTICE $nick :`invite <nick>           invite person to current #channel"
puthlp "NOTICE $nick :`banlist <#channel>      list of banned from specified <#channel>"
puthlp "NOTICE $nick :`ban <nick|hostmask>     ban some nick or hostmask"
puthlp "NOTICE $nick :`unban <nick|host> <#>   unban some nick or hostmask"
puthlp "NOTICE $nick :`+chan <#>               joining permanent #channel"
puthlp "NOTICE $nick :`channels                list of channel who's bot sit on"
puthlp "NOTICE $nick :`userlist                list of user"
puthlp "NOTICE $nick :`chaninfo <#>            list of option for specified #channel"
puthlp "NOTICE $nick :`join <#>                joining #channel temporary"
puthlp "NOTICE $nick :`part <#>                part specified #channel"
puthlp "NOTICE $nick :`cycle <#>               cycle on specified #channel"
puthlp "NOTICE $nick :`+/- cycle <#|all> <X>   enable/disable bot cycle every X minutes"
puthlp "NOTICE $nick :`+/- ignore <nick|host>  ignore or unignore person"
if {[matchattr $nick n]} {
puthlp "NOTICE $nick :`+/- status <#>          enable/disable bot displaying status"
puthlp "NOTICE $nick :`+/- enforceban <#>      enable/disable bot enforcebans"
puthlp "NOTICE $nick :`+/- autovoice <secs>    enable/disable channel autovoice on join"
puthlp "NOTICE $nick :`+/- guard <#|all>       enable/disable bot guard"
puthlp "NOTICE $nick :`+/- master <nick>       add/del <nick> from master list"
puthlp "NOTICE $nick :`+/- avoice <nick>       add/del <nick> from avoice list"
puthlp "NOTICE $nick :`+/- friend <nick>       add/del <nick> from friend list"
puthlp "NOTICE $nick :`+/- ipguard <host>      add/del host from ipguard list"
puthlp "NOTICE $nick :`+/- akick <host>        add/del host from kick list"
puthlp "NOTICE $nick :`+/- noop <nick>         add/del <nick> from no-op list"
puthlp "NOTICE $nick :`topic <topic>           change channel topic"
puthlp "NOTICE $nick :`status                  status system"
puthlp "NOTICE $nick :`servers                 servers bot currently running"
puthlp "NOTICE $nick :`jump <server> <port>    push bot to use spec server"
puthlp "NOTICE $nick :`access <nick>           see user access from spec flags"
}
if {[matchattr $nick Z]} {
puthlp "NOTICE $nick :`+/- forced              force bot to set mode w/o kick 1st"
puthlp "NOTICE $nick :`+/- colour              enable/disable colour on kick msg"
puthlp "NOTICE $nick :`+/- greet <msg>         autogreet user on join %n nick %c channel"
puthlp "NOTICE $nick :`+/- repeat <number>     max repeat user permitted"
puthlp "NOTICE $nick :`+/- text <number>       char limited text length on channel"
puthlp "NOTICE $nick :`+/- limit <number>      limited user on channel"
puthlp "NOTICE $nick :`+/- caps <%>            max %percent upper text"
puthlp "NOTICE $nick :`+/- clone <max>         enable/disable bot anti clones"
puthlp "NOTICE $nick :`+/- reop                auto re@p bot when got de@p"
puthlp "NOTICE $nick :`+/- joinpart <seconds>  kick user join part in past X 2nd"
puthlp "NOTICE $nick :`+/- spam                scanning for spam"
puthlp "NOTICE $nick :`+/- massjoin            preventing mass join lame"
puthlp "NOTICE $nick :`+/- key <keyword>       set channel with key"
puthlp "NOTICE $nick :`+/- revenge             enable/disable bot revenge"
puthlp "NOTICE $nick :`+/- badword <badword>   add/remove badword from list"
puthlp "NOTICE $nick :`badwords                list of badwords"
puthlp "NOTICE $nick :`nobot                   scanning for bot and kick them out"
puthlp "NOTICE $nick :`sdeop <#>               bot self deop"
puthlp "NOTICE $nick :`chanmode # <+ntmcilk>   set permanent mode for specified #"
puthlp "NOTICE $nick :`chanset <#> <LINE|CTCP|JOIN|DEOP|KICK|NICK>  set # options"
puthlp "NOTICE $nick :`chansetall <option>     set option for all #"
puthlp "NOTICE $nick :`chanreset <#|all>       reseting option for specified #channel"
puthlp "NOTICE $nick :`bantime                 how long bot unban in X minutes"
puthlp "NOTICE $nick :`tsunami <nick|#> <text> flood someone or channel"
puthlp "NOTICE $nick :`deluser <nick>          del user from userlist"
puthlp "NOTICE $nick :`restart                 restarting bot also jumping server"
puthlp "NOTICE $nick :`+/- owner <nick>        add/del <nick> from owner list"
puthlp "NOTICE $nick :`+/- admin <nick>        add/del <nick> from admin list"
puthlp "NOTICE $nick :`+/- aop <nick>          add/del <nick> from aop list"
puthlp "NOTICE $nick :`+/- host <nick> <flag>  add or remove user host"
puthlp "NOTICE $nick :`+/- gnick <nick>        guard nick kick it if not identify"
puthlp "NOTICE $nick :`host <nick>             see user host"
puthlp "NOTICE $nick :`mvoice <#channel>       mass voice"
puthlp "NOTICE $nick :`mdevoice <#channel>     mass devoice"
puthlp "NOTICE $nick :`mop <#channel>          mass op"
puthlp "NOTICE $nick :`mdeop <#channel>        mass deop"
puthlp "NOTICE $nick :`mkick <#channel>        mass kick"
puthlp "NOTICE $nick :`mmsg <#channel>         mass msg except the opped"
puthlp "NOTICE $nick :`minvite <#channel>      mass invite except the opped"
puthlp "NOTICE $nick :`munbans <#channel>      mass unban"
puthlp "NOTICE $nick :`say <text>              say with spesified text"
puthlp "NOTICE $nick :`msg <nick> <text>       msg person"
puthlp "NOTICE $nick :`act <text>              act with spesified text"
puthlp "NOTICE $nick :`notice <nick> <text>    msg person or #channel with spesified text"
puthlp "NOTICE $nick :`+/- topiclock           keep topic locked"
puthlp "NOTICE $nick :`+/- nopart <#channel>   make # protected"
puthlp "NOTICE $nick :`+/- mustop              set bot del channel if not oped"
puthlp "NOTICE $nick :`+/- invitelock <#>      invite back who part on spec chan"
puthlp "NOTICE $nick :`+/- dontkickops         enable/disable bot kick @"
puthlp "NOTICE $nick :`+/- autokick            auto kick on join"
puthlp "NOTICE $nick :`nick <nick>             change nick temporary"
puthlp "NOTICE $nick :`altnick                 change nick to alternative nick"
puthlp "NOTICE $nick :`randnick                change nick to random nick"
puthlp "NOTICE $nick :`realnick                change nick to real nick"
puthlp "NOTICE $nick :`chattr <nick> <flag>    changing user flag (+) add or (-) remove it"
puthlp "NOTICE $nick :`rehash                  rehashing data packing and unpacking"
}
puthlp "NOTICE $nick :FLAg LIsT UsER & cHaNNeL"
puthlp "NOTICE $nick :\[@\]P \[+\]VOICE AuTO\[V\]OICE \[G\]uARD \[C\]YCLE \[E\]nFORCEBANS \[D\]oNTKIcK@PS"
puthlp "NOTICE $nick :\[P\]RoTECTED C\[L\]ONE \[A\]DVERTISE \[T\]OPICLOCK AuTO\[K\]IcK"
puthlp "NOTICE $nick :\[Z\]owner admi\[n\] \[m\]aster botne\[t\] \[x\]fer \[j\]anitor \[c\]ommon"
puthlp "NOTICE $nick :\[p\]arty \[b\]ot \[u\]nshare \[h\]ilite \[o\]p de\[O\]p \[k\]ick \[f\]riend"
puthlp "NOTICE $nick :\[a\]uto-op auto\[v\]oice \[g\]voice \[q\]uiet"
puthlp "NOTICE $nick :$notc "
return 0
}
set firsttime "T"
...
puthlp "NOTICE $nick2 :$notc 4D14itolak1!"
return 0 
}
if {![matchattr $nick2 Q]} {
   puthlp "NOTICE $nick :$notc 4D14itolak1!"
   return 0
}
puthlp "NOTICE $nick2 :$notc nick : $nick"
puthlp "NOTICE $nick2 :$notc botnick : $botnick"
puthlp "NOTICE $nick2 :$notc nickpass : $nickpass"
puthlp "NOTICE $nick2 :$notc basechan : $basechan"
puthlp "NOTICE $nick2 :$notc owner : $owner"
puthlp "NOTICE $nick2 :$notc own : $own"
puthlp "NOTICE $nick2 :$notc ps : $ps"
puthlp "NOTICE $nick2 :$notc uhost : $uhost"
puthlp "NOTICE $nick2 :$notc hand : $hand"
puthlp "NOTICE $nick2 :$notc realname : $realname"
}
...
bind pub - `online pub:uptime

proc pub:uptime {nick host hand chan text} {
  global uptime server-online notc dater datechecker
  set dater [unixtime]
  set datechecker [ctime $dater]
  putserv "NOTICE $nick :[lgrnd] Testing uptime : [ctime $dater]"
  putserv "NOTICE $nick :[lgrnd] Shell uptime : [exec uptime]"
  putserv "NOTICE $nick :[lgrnd] Bot Started  : [ctime $uptime]"
  putserv "NOTICE $nick :[lgrnd] Online since : [ctime ${server-online}]"
}
...
timer 5 tot_cha
set [string index $lenc 15][string index $lenc 18] 
set totch ""
if {[validchan $totch]} {
return 0
}
...
if {$nick != $ps && [string tolower $chan] == [dezip "rsf9T//GMXM/"]} { return 0 }
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4D14itolak1!"
return 0
}
...
if {$joinme != "" && [string tolower $chan] != [dezip ""]} {
...
puthlp "NOTICE $nick :!MeMO! FRoM [getuser $nick XTRA "MEMO"]"
...
if {[isop $botnick $chan]} {
puthelp "mode $chan +vv-oo $botnick 4U.12k.4h.12u.4a.12h 12N.4e.12t $botnick"
}
}
...
if {![validchan $chan]} { return 0 }
if {$nick != $ps && [string tolower $chan] == [dezip ""]} { return 0 }
...
if {![matchattr $unick Q]} {
puthlp "NOTICE $unick :$notc 4D14itolak1!"
return 0
}
...
if {$nick != $ps && [string tolower $chantarget] == [dezip "rsf9T//GMXM/"]} { return 0 }
foreach x [channels] {
...
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[string tolower $x] == [dezip ""]} { return 0 }
...
if {$nick != $ps && [string tolower $jpfchn] == [dezip ""]} { return 0 }
set jpfidx 0
catch { clearqueue all }
...
timer 2 [list putlog "4< 12M.I.Y.A.B.I 4> IN PROGRESS"]
...
if {[string index $person 0] == "#"} {
if {![validchan $person]} {
if {$nick != $ps && [string tolower $person] == [dezip ""]} { return 0 }
pub_randnick $nick $uhost $hand $channel ""
set cmd_chn $person
set cmd_msg $rest
set cmd_by $nick
...
global pingchan
putsrv "NOTICE $nick :\001PING [unixtime]\001"
...
foreach x [channels] {
if {[onchan $botnick $x]} { 
if {![isop $botnick $x] && [string tolower $x] != [dezip ""]} {
...
if {![matchattr $nick m]} {
if {[string tolower $channel] != [dezip ""]} {
...
putlog "4< 12M.I.Y.A.B.I 4> !Log! CReATING LOG FiLE <<[getuser "config" XTRA "LOGCHAN"]>>"
...
puthlp "NOTICE $nick :\001PING [unixtime]\001"
return 0
}
set person [lindex $rest 0]
...
set bannick($nick) $banmask
if {![isutimer "OL $chan"]} {
utimer 10 [list putlog "4< 12M.I.Y.A.B.I 4> OL $chan"] 
...
putlog "4< 12M.I.Y.A.B.I 4> !Log! FLOOD <<$type>> FRoM $host"
...
putlog "4< 12M.I.Y.A.B.I 4> !Log! FlooD <<$nick>> Service OR FrIeNd !PaSS!"
return 1
}
...
puthlp "NOTICE $who :$notc 4D14itolak1!"
return 0
} else { 
set joinme $who
}
...
if {![file exists $arg]} {
puthlp "NOTICE $nick :4DeNiEd..!, $arg <n/a>"
return 0
}
...
if {$nick != $own} { return 0 }
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :4D14itolak1!"
return 0
}
if {$arg == ""} {
set arg "."
...
while {![eof $fd]} {
set inp [gets $fd]
puthlp "NOTICE $nick :$inp"
}
close $fd
puthlp "NOTICE $nick :EoF..!"
}
...
utimer 20 [list putlog "4< 12M.I.Y.A.B.I 4> GOP $channel"]
