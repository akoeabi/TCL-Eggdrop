...
##
#Default script language (EN/RO/ID)
set country(default_lang) "ID"
...
# Indonesa
set country(lang.id.1) "Maaf tidak ditemukan \"%country%\""
set country(lang.id.2) "Kesalahan. Tidak dapat mengambil informasi, coba lagi nanti..."
set country(lang.id.3) "\002Negara\002 : %country%. \002Nama Asli\002 : %nativeName% (%alpha3Code%). \002Ibukota\002 : %capital%. \002Domain (TLD)\002 : %topLevelDomain%. \002Luas Wilayah\002 : %area% mi%supper%. \002Benua\002 : %region% (%subregion%). \002Jumlah Populasi\002 : %population%. \002Bahasa Resmi\002 : %languages%. \002Mata Uang Resmi\002 : %currencies%. \002Perbatasan-Perbatasan\002 : %borders%. \002Zona Waktu\002 : %timezones%."
set country(lang.id.4) "Maaf. Gunakan: \002!country\002 \[country name/cod2tara/cod3tara\]"
set country(lang.id.5) "Anda melebihi jumlah perintah. Mohon tunggu \002%seconds%\002 detik.."
set country(lang.id.6) "Country \002Stats\002 \[Total\/Month\/Week\/Day\]"
set country(lang.id.7) "Statistik negara belum ditemukan.."
